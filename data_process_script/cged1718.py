...
TRAIN_RAW18 = '/data/disk1/private/wangmuzi/raw_data/cged18'
ERNIE_DATA='/data/disk1/private/wangmuzi/data/ERNIE/cged17'
ERNIE_DATA18='/data/disk1/private/wangmuzi/data/ERNIE/cged18'
...
if __name__ == "__main__":
    ...
    # get_train_dev(TRAIN_RAW18+'/train_CGED2018.xml')
    get_train_dev_seg()
    # get_test_seg()
    # get_cut_sent_test()